...
def main() -> None:
    ...
    for rank, case in enumerate(cases):
        ...
        reciprocal_focal_scale_sweep = config.get("reciprocal_focal_scale_sweep")
        intrinsics_case = (
            shown_case if reciprocal_focal_scale_sweep is not None else case
        )
        reciprocal_focal_scale = (
            float(reciprocal_focal_scale_sweep[rank])
            if reciprocal_focal_scale_sweep is not None
            else 1.0
        )
        ...
        prompt_intrinsics[0] *= intrinsics_scale * reciprocal_focal_scale
        prompt_intrinsics[1] *= intrinsics_scale / reciprocal_focal_scale
        ...
        result: dict[str, object] = {
            ...
            "reciprocal_focal_scale": reciprocal_focal_scale,
            "model_id": config["model_id"],
        }
